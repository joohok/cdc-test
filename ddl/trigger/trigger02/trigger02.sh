...
db=trigger02db
filename=trigger02
statement='CREATE TABLE trigger01 (id int)'
statement2='CREATE TRIGGER tmp BEFORE UPDATE ON trigger01 EXECUTE REJECT'
statement3='ALTER TRIGGER tmp STATUS INACTIVE'
