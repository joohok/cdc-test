	  ...
	  if (j % interval == 0)
		...
		case 1:
		  ...
		  if (data_item->dml.num_cond_column > 0)
		    {
		      printf ("\t\tcond_column_data[%d]: %d\n", 0, *(int*)data_item->dml.cond_column_data[0]);
		      printf ("\t\tcond_column_data[%d]: %lf\n", 1, *(double*)data_item->dml.cond_column_data[1]);
		      printf ("\t\tcond_column_data[%d]: %f\n", 2, *(float*)data_item->dml.cond_column_data[2]);
		      printf ("\t\tcond_column_data[%d]: %d\n", 3, *(short*)data_item->dml.cond_column_data[3]);
		      printf ("\t\tcond_column_data[%d]: %lld\n", 4, *(int64_t*)data_item->dml.cond_column_data[4]);
		    }
